...
import { useIsomorphicLayoutEffect } from "@/components/_shared/sabraman/lib/hooks/use-isomorphic-layout-effect";
import { initRoundbit } from "@/components/_shared/sabraman/lib/roundbit";
...
export const RoundbitFrame = React.forwardRef<
	HTMLDivElement,
	RoundbitFrameProps
