...
export function TargetCursor({
  ...
  return (
    ...
    >
      ...
      />
      <div className="target-cursor-corner corner-tl absolute left-1/2 top-1/2 h-3 w-3 transform border-r-0 border-b-0" style={{ borderColor: cursorColor, borderWidth: 3, borderStyle: "solid", transform: "translate(-150%, -150%)" }} />
      <div className="target-cursor-corner corner-tr absolute left-1/2 top-1/2 h-3 w-3 transform border-l-0 border-b-0" style={{ borderColor: cursorColor, borderWidth: 3, borderStyle: "solid", transform: "translate(50%, -150%)" }} />
      <div className="target-cursor-corner corner-br absolute left-1/2 top-1/2 h-3 w-3 transform border-l-0 border-t-0" style={{ borderColor: cursorColor, borderWidth: 3, borderStyle: "solid", transform: "translate(50%, 50%)" }} />
      <div className="target-cursor-corner corner-bl absolute left-1/2 top-1/2 h-3 w-3 transform border-r-0 border-t-0" style={{ borderColor: cursorColor, borderWidth: 3, borderStyle: "solid", transform: "translate(-150%, 50%)" }} />
    </div>
  )
}
