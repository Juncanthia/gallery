...
const NebulaInteractiveMaterial = ({
  speed,
  color1,
  color2,
  color3,
  ...
  return (
    <mesh
      onPointerEnter={() => (targetHoverRef.current = 1)}
      onPointerLeave={() => (targetHoverRef.current = 0)}
    >
...
interface NebulaInteractiveProps {
  className?: string;
  speed?: number;
...
export default function NebulaInteractive({
  className,
  speed = 2.0,
