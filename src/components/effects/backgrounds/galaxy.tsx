...
export function Galaxy({
  ...
  useEffect(() => {
    ...
    if (mouseInteraction) { ctn.addEventListener("mousemove", handleMouseMove); ctn.addEventListener("mouseleave", handleMouseLeave) }

    return () => {
      cancelAnimationFrame(animateId); window.removeEventListener("resize", resize)
      ...
      ctn.removeChild(gl.canvas); gl.getExtension("WEBGL_lose_context")?.loseContext()
    }
