...
const DEFAULT_LABEL = "Variable Proximity"
const DEFAULT_FROM = "'wght' 100, 'wdth' 25"
const DEFAULT_TO = "'wght' 900, 'wdth' 151"

const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>(
  (props, ref) => {
    const {
      label = DEFAULT_LABEL,
      fromFontVariationSettings = DEFAULT_FROM,
      toFontVariationSettings = DEFAULT_TO,
      containerRef,
      radius = 50,
      falloff = "linear",
      className = "",
    ...
    return (
      <>
        ...
        <span
          ...
          className={cn("variable-proximity", className)}
          onClick={onClick}
