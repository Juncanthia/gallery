...
import { ChevronsUpDown as ChevronsUpDownIcon, Plus as PlusIcon, Bone as XIcon } from "lucide-react";
import {
  type ComponentProps,
  createContext,
...
export const TagsValue = ({
  ...
  return (
    <Badge className={cn("flex items-center gap-2", className)} {...props}>
      {children}
      {onRemove && (
        // biome-ignore lint/a11y/noStaticElementInteractions: "clickable badge"
        // biome-ignore lint/a11y/useKeyWithClickEvents: "clickable badge"
        <div
...
export const TagsEmpty = ({
  ...
  <CommandEmpty className={className} {...props}>{children ?? "No tags found."}</CommandEmpty>
);
