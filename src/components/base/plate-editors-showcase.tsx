  ...
  return (
    ...
    >
      <div className="flex w-full items-center gap-2 pl-2 md:pr-6">
        ...
        <div className="mx-2 hidden h-4 w-px shrink-0 bg-border sm:flex" role="none" />
        <a
        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="hidden h-8 items-center gap-1.5 rounded-md border p-[3px] shadow-none lg:flex">
            <div className="flex w-fit items-center gap-1 rounded-md">
              ...
              />
              <div className="mx-0 h-4 w-px shrink-0 bg-border" role="none" />
              <a
          ...
          <div className="mx-1 hidden h-4 w-px shrink-0 bg-border lg:flex" role="none" />
          <button
        ...
        <div className="h-(--height)">
          <div className="relative grid size-full gap-4">
            ...
            <div className="relative z-10 flex size-full justify-center overflow-hidden rounded-lg border bg-background md:rounded-xl">
              <div
                className="size-full max-w-full bg-background"
...
function DeviceButton({
  ...
  return (
    <button
      className={cn(
        "inline-flex size-6 items-center justify-center rounded-sm p-0 hover:bg-muted hover:text-muted-foreground",
...
function tabClass(active: boolean) {
  return cn(
    "inline-flex h-6 flex-1 cursor-pointer items-center justify-center gap-1.5 whitespace-nowrap rounded-sm px-2 py-1 font-medium text-xs transition-colors",
    active
