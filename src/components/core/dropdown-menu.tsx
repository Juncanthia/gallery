  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        variant === "switch" && "justify-between pr-2 pl-2",
        className
      )}
      checked={checked}
      {...props}
    >
      ...
      {variant === "switch" ? (
        <span
          aria-hidden="true"
          className="pointer-events-none relative ml-4 inline-flex h-4 w-7 shrink-0 items-center rounded-full bg-input transition-colors data-[checked=true]:bg-primary"
