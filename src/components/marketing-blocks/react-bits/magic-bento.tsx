...
function ParticleCard({
  ...
  return (
    <div ref={cardRef} className={cn("particle-container", className)} style={{ ...style, position: "relative", overflow: "hidden" }}>
      {children}
    </div>
  )
}
...
export function MagicBento({
  ...
  }, [gridRef, shouldDisableAnimations, enableSpotlight, spotlightRadius, glowColor])
  ...
  return (
    <div className="card-grid bento-section" ref={gridRef}>
      {CARD_DATA.map((card, index) => {
        ...
        return (
          <div key={index} className={baseClassName} style={cardProps.style}>
            <div className="magic-bento-card__header">
              <div className="magic-bento-card__label">{card.label}</div>
            </div>
            <div className="magic-bento-card__content">
