import { CalloutElementDocx } from '@/components/editor/nodes/callout-node-static';
import {
  CodeBlockElementDocx,
  CodeLineElementDocx,
  CodeSyntaxLeafDocx,
} from '@/components/editor/nodes/code-block-node-static';
import {
  ColumnElementDocx,
  ColumnGroupElementDocx,
} from '@/components/editor/nodes/column-node-static';
import {
  EquationElementDocx,
  InlineEquationElementDocx,
} from '@/components/editor/nodes/equation-node-static';
import { TocElementDocx } from '@/components/editor/nodes/toc-node-static';
