...
const NON_ANTD_IDS = new Set([
  ...
  "file-tree", "file-upload", "gantt", "github-stars-wheel", "glimpse", "hover-card",
...
export const GALLERY_NAV_GROUPS: GalleryNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      manifestItem("empty-state-manifest","EmptyState","空状态"),
  ...
  },
  {
    ...
    items: [
      ...
      componentItem({ id: "file-upload", en: "FileUpload", label: "文件上传",
