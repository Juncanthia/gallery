...
import { getGalleryApiDoc } from "../../catalog/api-registry"
import type { GalleryApiDoc } from "../../catalog/api-types"
import type { GalleryItem } from "../../catalog/types"
    ...
    implementations: [
      {
        source: "local",
        status: "stable",
        importPath: `@/components/base/${itemId}`,
      },
    ],
  }
}
