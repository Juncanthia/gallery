...
const data: Row[] = [
  { id: "1", blocks/status: "success", priority: "high", latency: 45, host: "api.example.com" },
  { id: "2", blocks/status: "error", priority: "high", latency: 320, host: "db.example.com" },
  { id: "3", blocks/status: "pending", priority: "low", latency: 200, host: "cdn.example.com" },
  { id: "4", blocks/status: "success", priority: "medium", latency: 80, host: "api.example.com" },
  { id: "5", blocks/status: "error", priority: "low", latency: 500, host: "worker.example.com" },
]
