...
const data: Task[] = [
  { id: "1", title: "Fix login bug", status: "open", priority: "high", assignee: "Alice" },
  { id: "2", title: "Add dark mode", status: "in-progress", priority: "medium", assignee: "Bob" },
  { id: "3", title: "Update docs", status: "open", priority: "low", assignee: "Charlie" },
  { id: "4", title: "Refactor auth", status: "done", priority: "high", assignee: "Alice" },
  { id: "5", title: "Design new logo", status: "open", priority: "medium", assignee: "Diana" },
  { id: "6", title: "Write tests", status: "in-progress", priority: "high", assignee: "Bob" },
  { id: "7", title: "Deploy staging", status: "open", priority: "low", assignee: "Eve" },
  { id: "8", title: "Review PRs", status: "done", priority: "medium", assignee: "Charlie" },
]
